...
class HeatBase_offsite : public StencilRadiusBase {
    ...
    public:
        ...
        HeatBase_offsite(const string& name, StencilList& stencils, int radius=1) : StencilRadiusBase(name, stencils, radius) {
...
class Heat1dStencil_offsite : public HeatBase_offsite {
    ...
    public:
        Heat1dStencil_offsite(StencilList& stencils, int radius=1) :
            HeatBase_offsite("Heat1D", stencils, radius) { }
        Heat1dStencil_offsite(const string& name, StencilList& stencils, int radius=1) :
            HeatBase_offsite(name, stencils, radius) { }

};
REGISTER_STENCIL(Heat1dStencil_offsite);
...
class Heat2dStencil_offsite : public Heat1dStencil_offsite {
    ...
    public:
        Heat2dStencil_offsite(StencilList& stencils, int radius=1) :
            Heat1dStencil_offsite("Heat2D", stencils, radius) { }
        Heat2dStencil_offsite(const string& name, StencilList& stencils, int radius=1) :
            Heat1dStencil_offsite(name, stencils, radius) { }

};
REGISTER_STENCIL(Heat2dStencil_offsite);
...
class Heat3dStencil_offsite : public Heat2dStencil_offsite {
    ...
    public:
        Heat3dStencil_offsite(StencilList& stencils, int radius=1) :
            Heat2dStencil_offsite("Heat3D", stencils, radius) { }
        Heat3dStencil_offsite(const string& name, StencilList& stencils, int radius=1) :
            Heat2dStencil_offsite(name, stencils, radius) { }

};

REGISTER_STENCIL(Heat3dStencil_offsite);
