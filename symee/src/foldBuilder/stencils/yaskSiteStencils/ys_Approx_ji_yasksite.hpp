#ifndef YS_ys_Approx_ji_yasksite_STENCIL
#define YS_ys_Approx_ji_yasksite_STENCIL
...
class ys_Approx_ji_yasksite_gen_class : public Dummy {
    ...
    public:
       ...
       ys_Approx_ji_yasksite_gen_class(StencilList& stencils) : Dummy("ys_Approx_ji_yasksite", stencils) {
       ...
       ys_Approx_ji_yasksite_gen_class(const string& name, StencilList& stencils) : Dummy(name, stencils) {
            //can support max. upto 3D space dimension
             INIT_GRID_4D(F_0, t, x, y, z); INIT_GRID_4D(F_1, t, x, y, z); INIT_GRID_4D(F_2, t, x, y, z); INIT_GRID_4D(F_3, t, x, y, z);
        ...
        virtual void define(const IntTuple& offsets) {
            ...
            tmp=tmp+0.220462211176770*F_0(t+0,x,y,z);
tmp=tmp+0.388193468843170*F_1(t+0,x,y,z);
tmp=tmp+0.328844319980060*F_2(t+0,x,y,z);
tmp=tmp+0.0625000000000000*F_3(t+0,x,y,z);
data(t+0,x,y,z) EQUALS tmp;
;
        }
};

REGISTER_STENCIL(ys_Approx_ji_yasksite_gen_class);
