...
class HeatBase : public StencilBase {
    ...
    public:
        ...
        HeatBase(const string& name, StencilList& stencils) : StencilBase(name, stencils) {
...
class Heat1dStencil : public HeatBase {
    ...
    public:
        Heat1dStencil(StencilList& stencils) :
            HeatBase("heat1d", stencils) { }
        Heat1dStencil(const string& name, StencilList& stencils) :
            HeatBase(name, stencils) { }

};
YS_REGISTER_STENCIL("heat1d",Heat1dStencil);
...
YS_REGISTER_STENCIL("heat2d",Heat2dStencil);
...
class Heat3dStencil : public Heat2dStencil {
    ...
    public:
        ...
        Heat3dStencil(const string& name, StencilList& stencils) :
            Heat2dStencil(name, stencils) { }

};

YS_REGISTER_STENCIL("heat3d",Heat3dStencil);
