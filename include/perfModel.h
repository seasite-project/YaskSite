...
class perfModel
{
    ...
    double getPrefetchEffects(cache_info cache);
    double getLatencyEffects(cache_info cache, bool temporal=false);
    ...
    void setReadWriteGrids(int numReadGrids_, int numWriteGrids_);
