...
class #DERIVED_STENCIL#_gen_class : public #BASE_STENCIL# {
    ...
    public:
       ...
       #DERIVED_STENCIL#_gen_class(StencilList& stencils) : #BASE_STENCIL#("#DERIVED_STENCIL#", stencils) {
       ...
       #DERIVED_STENCIL#_gen_class(const string& name, StencilList& stencils) : #BASE_STENCIL#(name, stencils) {
            //can support max. upto 3D space dimension
            #DEFINE_EXTRA_GRIDS#
...
YS_REGISTER_STENCIL("#DERIVED_STENCIL#", #DERIVED_STENCIL#_gen_class);
