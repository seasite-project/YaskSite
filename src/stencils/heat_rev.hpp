...
class HeatBase_rev : public StencilRadiusBase {
    ...
    public:
        ...
        HeatBase_rev(const string& name, StencilList& stencils, int radius=1) : StencilRadiusBase(name, stencils, radius) {
...
class Heat1dStencil_rev : public HeatBase_rev {
    protected:
        virtual double coeff(int di, int dj, int dk) const
        {
            if(dk==0)
    ...
    public:
        Heat1dStencil_rev(StencilList& stencils, int radius=1) :
            HeatBase_rev("heat1d_rev", stencils, radius) { }
        Heat1dStencil_rev(const string& name, StencilList& stencils, int radius=1) :
            HeatBase_rev(name, stencils, radius) { }

};
YS_REGISTER_STENCIL_RADIUS("heat1d_rev",Heat1dStencil_rev);

class Heat2dStencil_rev : public Heat1dStencil_rev {
    protected:
        virtual double coeff(int di, int dj, int dk) const
        {
            if(dj==0&&dk==0)
        ...
        virtual void points(GridValue& v, Grid &data, GridIndex t, GridIndex x, GridIndex y, GridIndex z)
        {
            Heat1dStencil_rev::points(v, data, t, x, y, z);
        ...
        virtual void boundaryHandling(Grid& data, GridIndex t, GridIndex x, GridIndex y, GridIndex z, Condition at_first_x, Condition at_last_x, Condition at_first_y, Condition at_last_y, Condition at_first_z, Condition at_last_z)
        {
            Heat1dStencil_rev::boundaryHandling(data, t,x,y,z,at_first_x,at_last_x,at_first_y,at_last_y,at_first_z,at_last_z);
    ...
    public:
        Heat2dStencil_rev(StencilList& stencils, int radius=1) :
            Heat1dStencil_rev("heat2d_rev", stencils, radius) { }
        Heat2dStencil_rev(const string& name, StencilList& stencils, int radius=1) :
            Heat1dStencil_rev(name, stencils, radius) { }

};
YS_REGISTER_STENCIL_RADIUS("heat2d_rev",Heat2dStencil_rev);


class Heat3dStencil_rev : public Heat2dStencil_rev {
    protected:
        virtual double coeff(int di, int dj, int dk) const
        {
            if((dj==0&&dk==0)&&(di==0))
        ...
        virtual void points(GridValue& v, Grid& data, GridIndex t, GridIndex x, GridIndex y, GridIndex z)
        {
            Heat2dStencil_rev::points(v, data, t, x, y, z);
            for(int r=1; r<=_radius; ++r)
            {
        ...
        virtual void boundaryHandling(Grid& data, GridIndex t, GridIndex x, GridIndex y, GridIndex z, Condition at_first_x, Condition at_last_x, Condition at_first_y, Condition at_last_y, Condition at_first_z, Condition at_last_z)
        {
            Heat2dStencil_rev::boundaryHandling(data, t,x,y,z,at_first_x,at_last_x,at_first_y,at_last_y,at_first_z,at_last_z);
    ...
    public:
        Heat3dStencil_rev(StencilList& stencils, int radius=1) :
            Heat2dStencil_rev("heat3d_rev", stencils, radius) { }
        Heat3dStencil_rev(const string& name, StencilList& stencils, int radius=1) :
            Heat2dStencil_rev(name, stencils, radius) { }

};

YS_REGISTER_STENCIL_RADIUS("heat3d_rev",Heat3dStencil_rev);
